  ...
  public String ApplicationSubmit() 
    {
        ...
        try {
            ...
            statement = connection.createStatement();
            statement1 = connection.createStatement();
            resultSet1 = statement.executeQuery("select * from application where applicantid='" + appliID  + "'" + "and jobid='" + objectId + "'");
            if (!resultSet1.next()) 
            {
            ...
            if (resultSet.next()) {
             ...
             String message = "";
              ...
              int r = statement.executeUpdate("insert into application values"
                        + "('" + applicationID + "' , '" + appliID + "' , '"+ objectId +"' , '"+ name + "' , '" + age + "' , '" + gender + "' , '" + mobileNum + "' , '" + emailID + "' , '" + education + "' , '" + workExp + "' , '" + status + "' , '" +message + "')");
                out = "ApplyJobOk";
            } else {
                out = "ApplyJobNotOk";
            }
